...
(cl:defmethod cl:initialize-instance :after ((m <set_arm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_arm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_tutorial-srv:<set_arm-request> is deprecated: use moveit_tutorial-srv:set_arm-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <set_arm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_tutorial-srv:pose-val is deprecated.  Use moveit_tutorial-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_arm-request>)))
  ...
  "moveit_tutorial/set_armRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_arm-request)))
  "Returns string type for a service object of type 'set_arm-request"
  "moveit_tutorial/set_armRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <set_arm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_arm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_tutorial-srv:<set_arm-response> is deprecated: use moveit_tutorial-srv:set_arm-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_arm-response>)))
  ...
  "moveit_tutorial/set_armResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_arm-response)))
  "Returns string type for a service object of type 'set_arm-response"
  "moveit_tutorial/set_armResponse")
