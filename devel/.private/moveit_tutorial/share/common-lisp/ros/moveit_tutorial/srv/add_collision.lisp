...
(cl:defmethod cl:initialize-instance :after ((m <add_collision-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_collision-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_tutorial-srv:<add_collision-request> is deprecated: use moveit_tutorial-srv:add_collision-request instead.")))
...
(cl:defmethod centre-val ((m <add_collision-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_tutorial-srv:centre-val is deprecated.  Use moveit_tutorial-srv:centre instead.")
  (centre m))

(cl:ensure-generic-function 'dimensions-val :lambda-list '(m))
(cl:defmethod dimensions-val ((m <add_collision-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_tutorial-srv:dimensions-val is deprecated.  Use moveit_tutorial-srv:dimensions instead.")
  (dimensions m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <add_collision-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_tutorial-srv:orientation-val is deprecated.  Use moveit_tutorial-srv:orientation instead.")
  (orientation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_collision-request>)))
  ...
  "moveit_tutorial/add_collisionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_collision-request)))
  "Returns string type for a service object of type 'add_collision-request"
  "moveit_tutorial/add_collisionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <add_collision-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_collision-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_tutorial-srv:<add_collision-response> is deprecated: use moveit_tutorial-srv:add_collision-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_collision-response>)))
  ...
  "moveit_tutorial/add_collisionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_collision-response)))
  "Returns string type for a service object of type 'add_collision-response"
  "moveit_tutorial/add_collisionResponse")
