...
(cl:defmethod cl:initialize-instance :after ((m <set_arm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_arm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cw3_team_14-srv:<set_arm-request> is deprecated: use cw3_team_14-srv:set_arm-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <set_arm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cw3_team_14-srv:pose-val is deprecated.  Use cw3_team_14-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <set_arm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_arm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cw3_team_14-srv:<set_arm-response> is deprecated: use cw3_team_14-srv:set_arm-response instead.")))
